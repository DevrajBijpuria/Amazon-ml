...
| files | `phase2/output/phase2_5/b0_reproduction_after_refactor/output/dev/matching_results.tsv`, `phase2/output/phase2_5/b0_reproduction_after_refactor/output/dev/candidate_pairs.tsv` |
...
| challenge validator (with_candidates: `python.exe validate_submission.py --matching C:\Users\dbijp\OneDrive\Desktop\amazon_aws\phase2\output\phase2_5\b0_reproduction_after_refactor\output\dev\matching_results.tsv --test-dir C:\Users\dbijp\OneDrive\Desktop\amazon_aws\phase2\output\phase2_5\b0_reproduction_after_refactor\output\dev\test_subset --candidate C:\Users\dbijp\OneDrive\Desktop\amazon_aws\phase2\output\phase2_5\b0_reproduction_after_refactor\output\dev\candidate_pairs.tsv --check-ids`) | PASS:  / PASS — no blocking issues found. Safe to submit. |
...
| stage | seconds |
|---|---|
| train_load_s1_gt | 8.1 |
| train_normalize_s1 | 2.0 |
| train_load_s2 | 13.0 |
| train_normalize_s2 | 8.2 |
| train_candidates_s2 | 7.1 |
| train_features_s2 | 7.2 |
| train_load_s3 | 16.1 |
| train_normalize_s3 | 6.7 |
| train_candidates_s3 | 4.9 |
| train_features_s3 | 4.5 |
| train_model | 0.5 |
| threshold_sweep | 0.1 |
| error_analysis | 25.2 |
| test_load_s1 | 4.0 |
...
| test_load_s2 | 12.1 |
| test_normalize_s2 | 6.8 |
| test_candidates_features_scores_s2 | 11.0 |
| test_load_s3 | 12.9 |
| test_normalize_s3 | 6.8 |
| test_candidates_features_scores_s3 | 10.4 |
